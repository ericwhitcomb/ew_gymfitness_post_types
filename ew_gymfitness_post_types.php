<?php
    /*
     * Plugin Name: EW Gym Fitness - Post Types
     * Plugin URI: 
     * Description: Add a new Post Type into WordPress
     * Version: 1.0
     * Author: Eric Whitcomb
     * Author URI: http://ericwhitcomb.com
     * Text Domain: ew_gymfitness
     */

    if (!defined('ABSPATH')) die();

    // Register new Custom Post Type
    function ew_gymfitness_class_post_type() {
    ...
    add_action( 'init', 'ew_gymfitness_class_post_type', 0 );
?>